...
//   useEffect(() => {
//     if (vendorQuotationDetails?.length > 0) {
...
//             const existingVendor = existingVendors[vendorIndex];
...
//                   name: `Vendor ${vendorIndex + 1}`,
//                   rate: 0,
//                   isPrimary: vendorIndex === 0, // Default first vendor as primary
//                   supplier_id: null,
//                   rfqSent: false,
//                 };
//           });
...
//       const quotation_detail_id = vendorQuotationDetails[index]?.quotation_detail_id;
...
//   useEffect(() => {
//     if (!id || !open || hasFetchedVendors.current) return;
...
//         const vendors = Array.from({ length: vendorCount }, (_, vendorIndex) => {
//           // Try to find a vendor by order of appearance (no vendor_index assumed)
...
//               name: `Vendor ${vendorIndex + 1}`,
//               rate: 0,
//               isPrimary: vendorIndex === 0, // Default first vendor as primary for new rows
//               supplier_id: null,
//               rfqSent: false,
//             };
//         });
