...
export const getFlagList = createAsyncThunk('flag/list', async (params, { rejectWithValue }) => {
  try {
...
export const deleteFlag = createAsyncThunk('flag/delete', async (id, { rejectWithValue }) => {
  try {
...
export const createFlag = createAsyncThunk('flag/create', async (data, { rejectWithValue }) => {
  try {
