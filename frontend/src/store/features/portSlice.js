...
export const getPortList = createAsyncThunk('port/list', async (params, { rejectWithValue }) => {
  try {
...
export const deletePort = createAsyncThunk('port/delete', async (id, { rejectWithValue }) => {
  try {
...
export const createPort = createAsyncThunk('port/create', async (data, { rejectWithValue }) => {
  try {
