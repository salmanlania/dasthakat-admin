...
const SubCategory = () => {
  ...
  const categoryPermission = user.permission.category.list && user.permission.category.add;
      ...
      title: (
        <div>
          ...
          <Input
            ...
            value={params.name}
            onChange={(e) => dispatch(setSubCategoryListParams({ name: e.target.value }))}
          />
        </div>
      ),
      dataIndex: 'name',
      ...
      title: (
        <div onClick={(e) => e.stopPropagation()}>
          ...
          <AsyncSelect
            ...
            onChange={(value) => dispatch(setSubCategoryListParams({ category_id: value }))}
          />
        </div>
      ),
      ...
      render: (_, { category_id, editable, category_name, sub_category_id }) =>
        editable ? (
          <AsyncSelect
            ...
            labelInValue
            onChange={(selected) =>
              onChange(sub_category_id, 'category_id', selected ? selected.value : null)
            }
            ...
            <div className="flex items-center gap-2">
              ...
              <Tooltip title="Save">
                <Button
                  ...
                  onClick={() => (sub_category_id === 'new' ? onCreate(record) : onUpdate(record))}
                />
              </Tooltip>
            </div>
          );
  ...
  return (
    <>
      <div className="flex flex-wrap items-center justify-between">
        ...
        <Breadcrumb items={[{ title: 'SubCategory' }, { title: 'List' }]} separator=">" />
      </div>
      ...
      <div className="mt-4 rounded-md bg-white p-2">
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            {permissions.add ? (
              <Button type="primary" onClick={() => dispatch(addNewSubCategory())}>
                Add New
              </Button>
            ) : null}
          </div>
