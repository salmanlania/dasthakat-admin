            ...
            <div className="flex gap-2 items-center">
              ...
              <Tooltip title="Save">
                <Button
                  ...
                  onClick={() =>
                    port_id === "new" ? onCreate(record) : onUpdate(record)
                  }
                />
              </Tooltip>
            </div>
      ...
      <div className="mt-4 bg-white p-2 rounded-md">
        <div className="flex justify-between items-center gap-2">
          <Input
            ...
            value={params.search}
            onChange={(e) =>
              dispatch(setPortListParams({ search: e.target.value }))
            }
          />
            ...
            permissions.delete
              ? {
                  ...
                  onChange: (selectedRowKeys) =>
                    dispatch(setPortDeleteIDs(selectedRowKeys)),
