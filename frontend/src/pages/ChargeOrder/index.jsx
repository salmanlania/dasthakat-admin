        ...
        <div>
          ...
          <div onClick={(e) => e.stopPropagation()}>
            <DatePicker
              ...
              onChange={(date) =>
                dispatch(setChargeOrderListParams({ document_date: date }))
              }
              format="DD-MM-YYYY"
            />
          </div>
      ...
      title: (
        <div onClick={(e) => e.stopPropagation()}>
          ...
          <AsyncSelect
            ...
            onChange={(value) =>
              dispatch(setChargeOrderListParams({ customer_id: value }))
            }
          />
        </div>
      ),
      ...
      title: (
        <div onClick={(e) => e.stopPropagation()}>
          ...
          <AsyncSelect
            ...
            onChange={(value) =>
              dispatch(setChargeOrderListParams({ vessel_id: value }))
            }
          />
        </div>
      ),
      ...
      title: (
        <div onClick={(e) => e.stopPropagation()}>
          ...
          <AsyncSelect
            ...
            onChange={(value) =>
              dispatch(setChargeOrderListParams({ event_id: value }))
            }
          />
        </div>
      ),
  ...
  return (
    <>
      <div className="flex justify-between items-center flex-wrap">
        ...
        <Breadcrumb
          items={[{ title: "Charge Order" }, { title: "List" }]}
          separator=">"
        />
      </div>
      ...
      <div className="mt-4 bg-white p-2 rounded-md">
        <div className="flex justify-between items-center gap-2">
          <Input
            ...
            value={params.search}
            onChange={(e) =>
              dispatch(setChargeOrderListParams({ search: e.target.value }))
            }
          />
