...
const Validity = () => {
  useDocumentTitle('Validity List');
            ...
            <div className="flex items-center gap-2">
              ...
              <Tooltip title="Save">
                <Button
                  ...
                  onClick={() => (validity_id === 'new' ? onCreate(record) : onUpdate(record))}
                />
              </Tooltip>
            </div>
          );
  ...
  return (
    <>
      <div className="flex flex-wrap items-center justify-between">
        ...
        <Breadcrumb items={[{ title: 'Validity' }, { title: 'List' }]} separator=">" />
      </div>
      ...
      <div className="mt-4 rounded-md bg-white p-2">
        <div className="flex items-center justify-between gap-2">
          <Input
            ...
            value={params.search}
            onChange={(e) => dispatch(setValidityListParams({ search: e.target.value }))}
          />
          ...
          rowSelection={
            permissions.delete
              ? {
                  ...
                  onChange: (selectedRowKeys) => dispatch(setValidityDeleteIDs(selectedRowKeys)),
