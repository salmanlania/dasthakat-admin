...
const CoaLevelThree = () => {
  useDocumentTitle('Chart Of Account Level Three List');
  ...
  const onBulkDelete = async () => {
    ...
    try {
      ...
      toast.success('Chart Of Account Level Threes deleted successfully');
      closeDeleteModal();
          ...
          {permissions.edit ? (
            <>
              <div className="flex items-center gap-1">
                <Tooltip title="Edit">
                  <Link to={`/general-ledger/coa/level3/edit/${sale_invoice_id}`}>
                    <Button
                      size="small"
                      type="primary"
