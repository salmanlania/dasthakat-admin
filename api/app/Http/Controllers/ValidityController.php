...
class ValidityController extends Controller
{
	...
	public function show($id, Request $request)
	{
		...
		return $this->jsonResponse($data, 200, "Validity Data");
	}

	public function validateRequest($request, $id = null)
	{
		$rules = [
			'name' => ['required', Rule::unique('validity')->ignore($id, 'validity_id')->where('company_id', $request['company_id'])->where('company_branch_id', $request['company_branch_id'])],
		];
	...
	public function store(Request $request)
	{
		...
		if (!isPermission('add', 'validity', $request->permission_list))
		...
		$user = Validity::create($insertArr);

		return $this->jsonResponse(['validity_id' => $uuid], 200, "Add Validity Successfully!");
	}

	public function update(Request $request, $id)
	{
		if (!isPermission('edit', 'validity', $request->permission_list))
			return $this->jsonResponse('Permission Denied!', 403, "No Permission");
		...
		return $this->jsonResponse(['validity_id' => $id], 200, "Update Validity Successfully!");
	}
	public function delete($id, Request $request)
	{
		if (!isPermission('delete', 'validity', $request->permission_list))
			return $this->jsonResponse('Permission Denied!', 403, "No Permission");
	...
	public function bulkDelete(Request $request)
	{
		...
		try {
			...
			return $this->jsonResponse('Deleted', 200, "Delete Validity successfully!");
		} catch (\Exception $e) {
