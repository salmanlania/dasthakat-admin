 ...
 ('User Management', 'User Permission', 'user_permission', 'list', 'List', 1.101),
  ...
  ('General Ledger', 'Coa Level 1', 'coa_level_1', 'list', 'List', 1.101),
  ('General Ledger', 'Coa Level 1', 'coa_level_1', 'add', 'Add', 1.102),
  ('General Ledger', 'Coa Level 1', 'coa_level_1', 'edit', 'Edit', 1.103),
  ('General Ledger', 'Coa Level 1', 'coa_level_1', 'delete', 'Delete', 1.104),
  
  ('General Ledger', 'Coa Level 2', 'coa_level_2', 'list', 'List', 1.101),
  ('General Ledger', 'Coa Level 2', 'coa_level_2', 'add', 'Add', 1.102),
  ('General Ledger', 'Coa Level 2', 'coa_level_2', 'edit', 'Edit', 1.103),
  ('General Ledger', 'Coa Level 2', 'coa_level_2', 'delete', 'Delete', 1.104),
  
  ('General Ledger', 'Coa Level 3', 'coa_level_3', 'list', 'List', 1.101),
  ('General Ledger', 'Coa Level 3', 'coa_level_3', 'add', 'Add', 1.102),
  ('General Ledger', 'Coa Level 3', 'coa_level_3', 'edit', 'Edit', 1.103),
  ('General Ledger', 'Coa Level 3', 'coa_level_3', 'delete', 'Delete', 1.104),
